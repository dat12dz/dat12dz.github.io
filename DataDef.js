...
VillaDataBase.VillaList.push(new VillaDataBase("Khu làng Nhật Bản","Chỉ 300k/vé/người du ngoạn tại khu làng Nhật Bản ",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("E58 Villa","Mỗi sáng thức dậy tôi lại mỉm cười và hai mươi tư tiếng hạnh phúc sẽ ở ngay trước mắt tôi. Tôi nguyện sống trọn vẹn ý nghĩa cho từng giây và nhìn mọi điều bằng ánh mắt nhân ái. <br>",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("Villa sân Golf","VILLA GIÁ RẺ NHẤT SÂN GOLF TAM ĐẢO<br>Địa chỉ Sân golf Tam Đảo",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("USPACE VILLA","USPACE VILLA<br>Nam trong khu san golf Tam Đao ",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("Bobby Villa"," Biệt thự Bobby Villa view núi 10PN",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("KAO Homestay","KAO Homestay 6PN<br>Địa chỉ Xóm Núi cổng 1 xã Minh Phú Sóc Sơn Hà Nội ",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("Lavita 2","Lavita Villa nằm trọn tại trung tâm của hồ Đồng Đò trong xanh quanh năm ",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("5PN Sóc Sơn","VILLA 5PN  ",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("Villa hồ Đồng Đò 2","Villa nằm yên bình ngay bên hồ Đồng Đò thơ mộng",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("BENN VILLA","SIÊU BIỆT THỰ BENN VILLA  TUẦN CHÂU ",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("Villa 5PN","Căn Villa 5 PN với View siêu hót hít nội thất sang trọng",0,0,"Chưa có file nào","",1000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("DLIORO HOTEL RESORT","DLIORO HOTEL RESORT  HẠ LONG",5,4,"/Villa/HạLong/DLIOROHOTEL","/Villa/HạLong/DLIOROHOTEL/Picture/image018.jpg",8000000)); 
...
VillaDataBase.VillaList.push(new VillaDataBase("BT6A-01 FLC Villa","Toạ lạc ở vị trí đắc địa được coi là mảnh đất đắt đỏ nhất nơi tinh hoa núi trời; nơi hội tụ đẳng cấp bậc nhất của giới thượng lưu. BT6A-01 chắc chắn là lựa chọn tuyệt vời nhất; đẳng cấp nhất cho kì nghỉ của quý khách tại mảnh đất Hạ Long xinh đep.<br>Mã Villa BT6A-01",19,4,"/Villa/HạLong/VILLAFLCBT6A01","/Villa/HạLong/VILLAFLCBT6A01/Picture/image024.jpg",5000000)); 
VillaDataBase.VillaList.push(new VillaDataBase("BT6B-28 FLC Villa","BT6B-28 VILLA FLC HẠ LONG 6PN BỂ BƠI RIÊNG",17,4,"/Villa/HạLong/VILLAFLCHALONG6PN","/Villa/HạLong/VILLAFLCHALONG6PN/Picture/image012.jpg",5000000)); 
